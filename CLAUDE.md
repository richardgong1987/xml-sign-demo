...
- ES Modules (`"type": "module"`), Node >= 20.11. Relative imports carry the `.js` extension; `import.meta.dirname` replaces `__dirname`.
...
- ES Modules with explicit `.js` extensions on relative imports, Node >= 20.11.
