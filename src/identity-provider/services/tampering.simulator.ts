/*
 * Demo only: simulates a browser or network man-in-the-middle editing the signed XML
 * after the IdP produced it and before the browser POSTs it to the SP.
 *
...
export function tamperWithRole(signedSamlResponse: string): string {
